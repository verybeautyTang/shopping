<template>
  <div>
    ...
    <el-dialog title="分配权限"
      ...
      width="30%">
      <el-tree :data="roleList" :props="roleProp" refs="treeRef" show-checkbox default-expand-all :default-checked-keys="defkeys" node-key="id"></el-tree>
...
export default {
  ...
  methods: {
    ...
    // 点击确定分配权限
    async setRightSend () {
      const key = [...this.$ref.treeRef.getCheckedKeys(), ...this.$ref.treeRef.getHalfCheckedKeys()]
      const idr = key.join(',')
