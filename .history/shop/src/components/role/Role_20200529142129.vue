      ...
      <el-table :data="getRole" border stripe>
        ...
        <el-table-column  label="操作">
          <template><!--  slot-scope="scope" -->
            ...
            <el-button size="mini" type="warning" icon="el-icon-setting" @click="showRowList">分配权限</el-button>
          </template>
        </el-table-column>
      </el-table>
    </el-card>
    <el-dialog title="树形列表"
      :visible.sync="dialogVisible"
      width="30%">
      <el-tree :data="roleList" :props="roleProp"  show-checkbox default-expand-all node-key="id"></el-tree>
